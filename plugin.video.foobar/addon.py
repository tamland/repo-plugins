...
def root():
    items = [
        ...
        (plugin.url_for(search), ListItem("SÃ¸k"), True),
    ]
...
def add_radio_channels():
    radio_channels = [
        ...
        ("P3 UrÃ¸rt", "http://lyd.nrk.no/nrk_radio_p3_urort_mp3_h"),
        ("Sport", "http://lyd.nrk.no/nrk_radio_sport_mp3_h"),
        ("SÃ¡pmi", "http://lyd.nrk.no/nrk_radio_sami_mp3_h"),
        ...
        ("P1 MÃ¸re og Romsdal", "http://lyd.nrk.no/nrk_radio_p1_more_og_romsdal_mp3_h"),
        ...
        ("P1 SÃ¸rlandet", "http://lyd.nrk.no/nrk_radio_p1_sorlandet_mp3_h"),
        ("P1 Telemark", "http://lyd.nrk.no/nrk_radio_p1_telemark_mp3_h"),
        ("P1 Troms", "http://lyd.nrk.no/nrk_radio_p1_troms_mp3_h"),
        ("P1 TrÃ¸ndelag", "http://lyd.nrk.no/nrk_radio_p1_trondelag_mp3_h"),
        ("P1 Vestfold", "http://lyd.nrk.no/nrk_radio_p1_vestfold_mp3_h"),
        ("P1 Ãstfold", "http://lyd.nrk.no/nrk_radio_p1_ostfold_mp3_h"),
    ]
